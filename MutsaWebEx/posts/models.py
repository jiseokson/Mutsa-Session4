...
class Post(models.Model):
    writer = models.ForeignKey(verbose_name='writer', to=User, on_delete=models.CASCADE)
...
class Comment(models.Model):
    writer = models.ForeignKey(verbose_name='writer', to=User, on_delete=models.CASCADE)
    comment_on = models.ForeignKey(verbose_name='comment on', to=Post, on_delete=models.CASCADE)
    content = models.TextField(verbose_name='content')
